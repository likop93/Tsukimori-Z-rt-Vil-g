...
| 1 | `canonical_html_chapter_1`, 94–173. sor | Falusi pillantások, Katsuro háza, Miyako első mondata, beszélgetés és első választás; utána az **első éjszaka** és a hallott férfihang. | Falun áthaladás és a néma, térbeli találkozási animáció működik. A mondat, a beszélgetés, a döntés és az első éjszaka még nincs beépítve. |
| 2 | `canonical_html_chapter_2`, 174–496. sor | **Második reggel:** Miyako konyhai jelenete és érintésdöntés; Katsuro lezárt dolgozószobája, amelynek kulcsa Miyakónál van; a rendelő, a feljegyzés és Akira szakmai szabálya; **első rendelési nap reggele** és újabb döntés. | Ugyanabban a jóváhagyott közös házban; a rendelőszárny bejárható. A konyha, dolgozószoba és történeti jeleneteik még nem játszhatók. |
...
|---|---|---|
| `aff_miyako`, `aff_hana`, `aff_shion`, később `aff_sora`, `aff_ritsu`, `aff_kuroe` | Kezdetben 0; döntésenként nőnek. | A választások még nem játszhatók Godotban; az értékeket a tényleges jelenetekkel együtt vezetjük be. |
| `akira_gyogyulas`, `akira_elmerules` | Külön tengelyek, kezdetben 0. | A két érték Ren’Py-kánon; az első játszható döntésekkel együtt kerülnek át. |
| `flag_*`, `story_flags`, `patient_seen`, `codex_unlocked` | Egyszeri döntések, jelenetek, páciens- és karakterfelfedezések. | A Godotban jelenleg csak térbeli bejárási és találkozási jelzők vannak; a történeti jelzők a hozzájuk tartozó jelenettel érkeznek. |
...
|---|---|---|---|
| Első éjszaka | `canonical_html_chapter_1`, a Miyako-választás után: Akira nem alszik, hajnal előtt idegen férfihangot hall. Nincs új döntés. | A közös házban, a még készülő beszélgetés után. A jelenlegi találkozás csak néma animációs próba. | Mindkét első választás azonos éjszakai jelenetbe fut; a korábbi pontváltozások megmaradnak. |
| Második reggel, konyha | `canonical_html_chapter_2`, 174. sortól: Miyako, tea, Katsuro múltja, kézérintés. **Marad:** `aff_miyako +1`, `akira_gyogyulas +1`. **Távolság:** `flag_miyako_tavolsag = True`, pontnövekedés nélkül. | Ugyanazon közös ház később kialakítandó konyhai jelenete; nem új lakóépület. | A két ágon pontos Ren’Py-szöveg és állapot, majd közös visszatérés a dolgozószoba beszélgetéséhez. |
...
**Megjelenítési sorrend:** a jelenetek mozgását és kameraütemét előbb a Godot-térben építjük fel. A Ren’Py pontos dialógusai és döntései kánonként ebben a jegyzékben maradnak; a korábbi teljes képernyős, állóképes VN-próbát kivettük a játszható projektből, mert elütött a bejárható világtól.
